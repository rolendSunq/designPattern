 ...
 * <p>
 * This class enables a good hashcode to be built for any class. It follows the
 * rules laid out in the book Effective Java, by Joshua Bloch. Writing a good
 * hashCode is actually quite difficult. This class aims to simplify the
 * process.
 * <p>
 ...
 * method must be used in the hashCode method.
 * <p>
...
public class HashCodeBuilder {
	...
	/**
	 * Constructor for HashCodeBuilder. This constructor uses two hard coded
	 * choices for the constants needed to build a hashCode.
	 */
	...
	/**
	 * Constructor for HashCodeBuilder. Two randomly chosen, non-zero, odd
	 * numbers must be passed in. Ideally these should be different for each
	 * class, however this is not vital. Prime numbers are preferred, especially
	 * for the multiplier.
	 * 
	 ...
	 * that it will throw a security exception if run under a security manger,
	 * if the permissions are not set up. It is also not as efficient as testing
	 * explicitly. Transient members will be not be used, as they are likely
	 * derived fields, and not part of the value of the object. Static fields
	 * will not be tested. This constructor uses two hard coded choices for the
	 * constants needed to build a hash code.
	 * 
	 * @param object
	 ...
	 * that it will throw a security exception if run under a security manger,
	 * if the permissions are not set up. It is also not as efficient as testing
	 * explicitly. If the TestTransients parameter is set to true, transient
